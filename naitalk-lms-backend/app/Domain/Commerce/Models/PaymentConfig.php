...
class PaymentConfig extends Model
{
    ...
    {
        static::creating(function (PaymentConfig $config) {
    ...
    {
        return $this->commission_percent ?? (float) config('services.managed_payments.default_commission_percent');
    }

    /** The URL the organization must paste into their Paystack/Flutterwave
