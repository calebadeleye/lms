  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-2 lg:items-center lg:py-20">
          <div>
            <h1 className="text-4xl font-extrabold leading-tight text-neutral-900 sm:text-5xl">
              ...
              <span className="text-[var(--tenant-accent)]">{homepage.hero_highlight}</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/courses"
                className="rounded-md bg-[var(--tenant-accent)] px-6 py-3 text-sm font-semibold text-white shadow-sm hover:opacity-90"
              >
                {homepage.hero_cta_primary ?? 'Explore Courses'}
              </Link>
              <Link
                href="/coaching"
                className="rounded-md border border-[var(--tenant-primary)] px-6 py-3 text-sm font-semibold text-[var(--tenant-primary)] hover:bg-neutral-50"
              >
          ...
          <div className="relative aspect-4/3 w-full overflow-hidden rounded-2xl bg-linear-to-br from-[var(--tenant-primary)] to-[var(--tenant-secondary)]/60">
        ...
        {/* Stats bar */}
        {stats.length > 0 && (
          <section className="bg-[var(--tenant-primary)] py-8">
            ...
            <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {howWeHelp.map((item) => (
                <div key={item.title} className="rounded-xl border border-neutral-200 p-6 text-center">
                  <div className="mx-auto mb-3 grid h-10 w-10 place-items-center rounded-full bg-[var(--tenant-accent)]/15 text-[var(--tenant-accent)]">
                    ✦
                  </div>
        ...
        {config.testimonials.length > 0 && (
          <section className="bg-[var(--tenant-primary)] py-14">
